...
このように、グループQの一部の役員たちに仲間内の平穏最優先の文化的背景があるという仮説の下では、Mにとっては異様に感じられたP氏ほか一部の役員たちの言動を合理的に解釈できます。また、異文化から来たMの言動を役員たちが持て余しているだろうことも想像できます。

以上の仮説が正しいかどうかはわかりませんが、いずれにせよ、グループQでは現状が内包する問題点を指摘すること自体が問題視され、事実上禁じられました。これによってMの発言は大幅に制限されます。
