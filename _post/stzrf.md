...
しかしこれまでになされた幾つかの小さな決定の経過を観察した限り、グループQは、法律や基準よりも自分の感覚を優先した判断で会を運営する傾向があるようです。

事項 | 法律や 基準 | 会の判断
|: --- |: --- |: --- |
1. 表紙を 読む 仕様で 奥付 改変 | やっては いけない | やる
2. 標題紙 セクションの タイトルに 第1 フレーズ 記入 | やって良い | やらない
3. 原本 ページ 境目 前後で 近い 方で 始まる フレーズに ページ 付け | やって良い | やらない
4. 他館の デイジー版の 一部を 利用者 個人 使用 だけの ために 改変 | やって良い | やらない

1,2,4の判断の客観的根拠は示されていません。3だけは「ページをめくって最初に始まるフレーズにページ付け」というより簡単な判断方法があり、法律や基準とも矛盾しないという根拠があります。

「ボランティア」とは自らすすんでやるという意味ですから、役員が自らすすんで法律や基準を軽視し、主観的な根拠や感覚に頼って会を運営するのも良いでしょう。
似たような主観を持つもの同士、結束が高まり、安定した運営ができそうです。
その代わり、客観的な根拠のない決定方法を続ける限り、主観的にそれに従いたくない会員が出てくる可能性は常にあります。
各会員もボランティアですから、自らすすんでやりたくないことを強要する会からは退会することになります。
