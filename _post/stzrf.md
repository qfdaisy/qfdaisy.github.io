...
さらに、P氏や一部の役員が、原本対応部分に対する音訳者の決定権を侵害してまで事象Bの実現を強要するのも、また、違法の可能性を排除できないことでさえ、慣習維持のためには他人に指導し続けるのを厭わないのも、真実よりも平穏が優先であるという前提の下では当然の言動と考えられます。

このように、グループQの一部の役員たちに平穏最優先の文化的背景があるという仮説の下では、Mにとっては異様に感じられたP氏ほか一部の役員たちの言動を理解できます。また、異文化から来たMの言動を役員たちが持て余しているだろうことも想像できます。
