...
前会長P氏からのMに対する厳しいご意見は、臨席しなかった役員にも伝わっていることでしょう。
その一方で、Mには弁明の機会が巡ってきませんでした。
そのため、Mが役員会の決定に背いているかのように誤解されているものと推察しております。

そこで、事のいきさつをMの視点から記録しておくことにしました。

会の平穏のためには、誤解を残したまま去るべきだというお考えはあるでしょう。
またM自身も、弁明によって誤解が解けるどころか、Mに対する一層の嫌悪感を呼び起こすに過ぎない可能性が高いと考えています。
しかし、このような弁明に人々が何らかの反応をするのかどうか実験してみたいという好奇心の方が、敵意を受ける苦しみに優っているのです。
...
その一方、事象Aの採択にとどめた上で、指導に従わない会員に音訳を担当させないことにするなら、それは上記の意味で「合法」であるが、音訳能力自体が欠如しているなどの他の忌避条件がない場合、状況によってはパワハラとなる可能性がある。（注 終わり）
{: .note}
...
もともとグループQ内では、音訳者が読みを決めかねて、いくつかのバージョンの読みを録音しておき、最終決定を編集者に任せるということが度々ありました。そうすると、万が一納品後に読みに関して問題が発覚した場合、本来は音訳者が取るべき責任を編集者に負わせることが可能になるので、編集者にとっては危険な慣習です。
...
この事件以後、これよりもっと以前にMが書いて学習資料集に載せていた数々の解説文が、グループQの複数の役員から、「攻撃的である」として問題視されるようになりました。Mに対するP氏の苦言が他の役員たちに伝わったことで、過去の文章も注目を集めることになったのでしょう。

学習資料集は公式見解発表の場ではなく、学習に役立ちそうな内容を会員が自由に載せることができる場所でした。学習資料集の内容が会員以外の人々にも役立つことを期待し、役員会の許可を得て公開状態にしていました。

グループQ会員は誰でも、個人情報や機密事項以外なら何でもここに掲載できるという旨が学習資料集の一番上に明示されていましたので、その内容が公式見解ではないことは外部の人間にも明らかであり、役員会が監視制御する必要も権限もないはずでした。
...
Mはこの要請を受け、学習資料集を閉鎖しました。Mが1人で書いた文章の一部については、グループQとの繋がりを想起させる表現を消した上で別サイトに再掲するための作業を続けています。残りの文章については、会員のみが閲覧可能なクラウドドライブへ移動しました。

## 2. 判断の根拠

Mは法律や基準に照らし合わせて、やって良いことについては寛容ですが、やってはいけないことを他人に勧めたくありませんし、それを指示されてもやりたくありません。

しかしこれまでになされた幾つかの小さな決定の経過を観察した限り、グループQは、法律や基準による根拠を示さずに、役員の個人的感覚を優先した判断で会を運営する傾向があるようです。

法律や基準には、するべきこと、してはいけないこと、してもしなくても良いことが示されています。それぞれを要、不可、可と書き、個別の事案に対する役員たちの判断と比較すると、以下のようになります。

事項 | 法律や 基準 | 会の 判断 | 判断 根拠
|:---|:---|:---|
1. 奥付を記載通りに録音 | 要 | しない | 無し
2. 表紙を 読む 仕様で 奥付 改変 | 不可 | する | 無し
3. 標題紙 セクション 見出し に 「標題紙」 と 記入 | 可 | する | 無し
4. 標題紙 セクション 見出し に 第1 フレーズ 記入 | 可 | しない | 無し
5. 原本 ページ 境目 前後の 近い 方で 始まる フレーズに ページ 付け | 可 | しない | 無し
6. 原本 ページ めくって 最初に 始まる フレーズに ページ 付け | 可 | する | 無し
7. 他館の デイジー 版の 一部を 利用者 個人 使用 だけの ために 改変 | 可 | しない | 無し

（注）
5,6の判断根拠については、当時Mが不完全な形で示していたが、その判断が基準によって許される根拠は示していない。実は基準への質問に対する回答集に「該当ページにページを付けるのが原則と思いますが、ページの先頭からかなり離れたフレーズでないとページが付けられない場合は、前のページから続いているフレーズに付ける場合もあります。」と書かれているので、ページ境目前後のフレーズ長を正確に測定してページ付けを選択する必要がないことが読み取れる。また「かなり離れたフレーズ」の判断基準は書かれていないため、「99999文字」「99999秒」といった十分に長い判断基準を設ければ、現実的には「ページをめくって最初に始まるフレーズ」にページ付けをして良いことを、客観的根拠として明示できたはずだが、そのような説明はなされなかった。（注 終わり）
{: .note}

「ボランティア」とは自らすすんでやるという意味ですから、役員が自らすすんで法律や基準を軽視し、主観的な根拠や感覚に頼って物事を決定するのも良いでしょう。
似たような主観を持つもの同士で結束が高まり、楽しく会を運営できることと思います。

その代わり、客観的な根拠のない決定方法を続ける限り、異なる価値観を持つ人を納得させることはできません。

3から7のような、しても良いことをしないという判断については、感覚だけで判断しても大した問題は起きないでしょう。その一方で、1のようなするべきことをしないで2のような禁止事項をするという判断については、その客観的根拠を示さずにすれば、主観を異にする会員への理不尽な強要となる可能性があります。

各会員もボランティアですから、自らすすんでやりたくないことを無根拠に強要する会からは退会することになります。

客観的根拠を出さない運営は、そのようにして異質な会員を排除する性質を内包しています。Mが退会するのはそのようなグループQの排他性の結果でした。
