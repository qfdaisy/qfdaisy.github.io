...
|:---|:---|:---|
1. 表紙を 読む 仕様で 奥付 改変 | やっては いけない | やる | 無し
2. 標題紙 セクションの タイトルに 第1 フレーズ 記入 | やって良い | やらない | 無し
3. 原本 ページ 境目 前後で 近い 方で 始まる フレーズに ページ 付け | やって良い | やらない | 有り
4. 他館の デイジー版の 一部を 利用者 個人 使用 だけの ために 改変 | やって良い | やらない | 無し
...
2や4のような、やっても良いことをやらないという決定については、感覚だけで判断しても問題は起きないでしょう。その一方で1のように客観的根拠を出さずに、やってはいけないことをやるという決定をすれば、主観を異にする会員への理不尽な強要となる可能性があります。

各会員もボランティアですから、自らすすんでやりたくないことを無根拠に強要する会からは退会することになります。

客観的根拠を軽視する運営は、そのようにして異質な会員を排除する性質を内包しています。Mが退会するのはそのようなグループQの排他性の結果でした。
