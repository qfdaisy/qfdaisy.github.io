...
しかしこれまでになされた幾つかの小さな決定の経過を観察した限り、グループQは、法律や基準よりも、役員の個人的感覚を優先した判断で会を運営する傾向があるようです。

事項 | 法律や 基準 | 会の 判断 | 客観的 根拠
|:---|:---|:---|
1. 表紙を 読む 仕様で 奥付 改変 | しては いけない | する | 無し
2. 標題紙 セクション 見出し に 第1 フレーズ 記入 | して 良い | しない | 無し
3. 原本 ページ 境目 前後で 近い 方で 始まる フレーズに ページ 付け | して 良い | しない | 有り
4. 他館の デイジー 版の 一部を 利用者 個人 使用 だけの ために 改変 | して 良い | しない | 無し
...
2や4のような、しても良いことをしないという決定については、感覚だけで判断しても大した問題は起きないでしょう。その一方で1のように客観的根拠を出さずに、してはいけないことをするという決定をすれば、主観を異にする会員への理不尽な強要となる可能性があります。
