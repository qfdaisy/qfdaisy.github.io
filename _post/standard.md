...
このような行為が原本の著作権侵害とみなされていないことから推察できるのは、伝統的な録音図書制作にあたっては、表紙・カバー・奥付が音声化の対象ではない、つまり原本の範囲外であるということだ。

表紙・カバー・（標題紙・）奥付が録音図書製作で原本とみなす範囲から外れているとすれば、それらの内容を忠実に音声化する必要はない。さらに、表紙・カバー・（標題紙・）奥付を「原本についての情報源（原本のメタ情報）」として扱い、それらから得られる情報を集約することによって録音図書独自の「原本奥付」セクションを作り出すことは、原本の著作権侵害にならないという解釈が可能になる。なぜなら、このようにして作り出された「原本奥付」セクションは、セクションタイトルこそ「原本奥付」であるが、原本自体の音声化ではなく、その実態は音声化に際して原本のメタ情報を集約したものであり、「この録音図書の原本について」とでも題すべきセクションなのだから。

逆に、伝統的録音図書の仕様においてメタ情報を音声として記録するためには、表紙・カバー・（標題紙・）奥付からメタ情報をかき集めて録音することが必要でさえある。

これと違って全国基準では、表紙・カバー・標題紙・奥付は録音資料の原本の一部分とみなされているので、表紙・カバー・標題紙を読まないことや、奥付に書かれていない情報を追加するという改変は、原本の著作権（同一性保持権）侵害にあたる可能性が出てくる。

著作権保護の対象となるのは「創作性を有するもの」である。表紙・カバー・標題紙に書かれているタイトルなどは当然創作性を有するし、それらの内容の編集の仕方やデザインが創作性を有する場合もある。奥付の内容についても、現代では法律や規則による縛りがないので[^okuduke]、「その素材の選択又は配列によつて創作性を有するもの」である編集著作物となり得る。極端な場合を考えると、例えば横書きの奥付に縦読みの暗号を仕込むことは可能で、もしそういった工夫があれば、それは明らかに著作権保護の対象である。
...
伝統的な録音図書の仕様はこれと異なり、表紙・カバー・（標題紙・）奥付が原本の一部分ではなく、原本についての情報源として扱われていることが推察される。

このように全国基準と伝統仕様とで「原本」の定義の違いがあることを前提にすれば、表紙・カバー・（標題紙・）奥付の扱いが大きく異なるのは当然である。

全国基準に従う場合には、表紙・カバー・標題紙を省略したり、奥付に改変を加えたりすることは、原本の同一性保持権を侵害することになる。

逆に、伝統的な録音図書の仕様で製作する場合には、原本のメタ情報を音声で記録しておくために、表紙・カバー・標題紙・奥付からメタ情報を収集し、それ専用のセクションを作り出す必要があるだろう。
